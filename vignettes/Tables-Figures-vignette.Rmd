...
As of this writing I am not aware of any figure packages that should be avoided. Each figure should be in its own chunk with a figure caption that begins with `(\\#fig:fig-label)` when being printed. Figure \@ref(fig:example-fig) is an example.

```{r, fig.cap="(\\#fig:example-fig) Boxplot of sepal length by species."}
