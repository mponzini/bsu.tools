...
* Creating hyperlinks: If there is a site or resource you want to reference you can create a hyperlink instead of a formal Reference section. To create a hyperlink use the following `[word](URL)`. The [word](https://rmarkdown.rstudio.com/authoring_basics.html) will become linked to the URL in the parentheses. 

* Reference Section: If there are multiple source that you need to cite you should create a formal references section. A brief overview of creating bibliographies and citations can be found in the [R Markdown Cookbook](https://bookdown.org/yihui/rmarkdown-cookbook/bibliography.html).
