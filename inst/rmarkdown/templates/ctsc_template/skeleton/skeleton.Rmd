...
subtitle: "<b>TO: </b> Investigator <br> <b> FROM: </b> Analyst <br> <b> SUBJECT:</b> Project Title <br> <b>DATE:</b> `r Sys.Date()` <br> <hr />"
output: 
...
htmltools::img(src = knitr::image_uri(file.path("CTSC_Stacked.jpg")), 
